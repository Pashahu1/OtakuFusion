      ...
      {seasons?.map((item) => {
        ...
        return (
          ...
          >
            ...
            <h4 className="relative z-10 flex min-h-[100px] flex-1 items-center justify-center p-4 text-center text-sm leading-snug font-medium text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] sm:text-base">
              {item.title}
            </h4>
          </Link>
        );
