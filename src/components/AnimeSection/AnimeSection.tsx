    ...
    <section className="w-full max-w-[1800px] xl:max-w-[2000px] 2xl:max-w-[2400px] mx-auto px-4 md:px-6 lg:px-10 py-8 space-y-6">
      {catalog.length > 0 && (
        <>
          ...
          <div
            className="grid gap-4 grid-cols-[repeat(auto-fit,_minmax(140px,_1fr))] md:grid-cols-[repeat(auto-fit,_minmax(180px,_1fr))] lg:grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] xl:grid-cols-[repeat(auto-fit,_minmax(240px,_1fr))] 2xl:grid-cols-[repeat(auto-fit,_minmax(260px,_1fr))]"
          >
            {catalog.map((anime) => (
