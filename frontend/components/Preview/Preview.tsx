              ...
              <div className="preview-card__header">
                <div className="preview-card__overlay">
                  ...
                  <p className="preview-card__overlay-text">
                    ...
                    aliquid nisi minima libero adipisci sequi eligendi soluta ullam accusamus
                    repudiandae in illo, facere blanditiis fugiat illum? Sunt, aut voluptates.
                  </p>
                  <button className="preview-card__overlay-button">Watch Season 1 Ep 1</button>
                </div>
              </div>
            </div>
          </SwiperSlide>
